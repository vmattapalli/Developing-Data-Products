...
shinyUI(
    navbarPage("Shiny Application",
               tabPanel("Analysis",
                        fluidPage(
                            titlePanel("The relationship b/n variables and miles per gallon (MPG)"),
                            sidebarLayout(
                                sidebarPanel(
                                    ...
                                    checkboxInput("outliers", "Show outlier", FALSE)
                                ),
                                ...
                                mainPanel(
                                    ...
                                    tabsetPanel(type = "tabs", 
                                                tabPanel("Distribution Plot", plotOutput("mpgBoxPlot")),
               ...
               tabPanel("Go back to my Github repository",
                        a("https://github.com/vmattapalli/Developing-Data-Products"),
                        hr(),
